//Generated at 2016-05-29 18:28:21
/*
...
#define APB_SPI_0_ADDR_PRE   ( 0x3ff43000 )
#define APB_SPI_1_ADDR_PRE   ( 0x3ff42000 )
#define APB_SPI_2_ADDR_PRE   ( 0x3ff64000 )
#define APB_SPI_3_ADDR_PRE   ( 0x3ff65000 )

#undef REG_SPI_BASE
#define REG_SPI_BASE( i ) ( APB_SPI_1_ADDR_PRE + (((i)>1) ? (((i)* 0x1000) + 0x20000) : (((~(i)) & 1)* 0x1000 )) )
