...
#define REG_I2C_BASE(i)    (0x60013000 + (i) * 0x14000 )
...
#define I2C_CTR_REG(i)          (REG_I2C_BASE(i) + 0x0004)
    ...
    /*description: Set this bit to configure the module as i2c master*/
    ...
    /*description: 1：normally ouput scl clock  0: exchange the function of scl_o and scl_oe (scl_o is the original internal output scl signal*/
    ...
    /*description: 1：normally ouput sda data   0: exchange the function of sda_o and sda_oe (sda_o is the original internal output sda signal*/
...
#define I2C_SR_REG(i)          (REG_I2C_BASE(i) + 0x0008)
    ...
    /*description: when configured as i2c slave*/
    ...
    /*description: when I2C lost control of SDA line*/
...
#define I2C_FIFO_CONF_REG(i)          (REG_I2C_BASE(i) + 0x0018)
    ...
    /*description: when I2C sends more than nonfifo_tx_thres data*/
    ...
    /*description: when I2C receives more than nonfifo_rx_thres data*/
    ...
    /*description: When this bit is set to 1*/
...
#define I2C_INT_RAW_REG(i)          (REG_I2C_BASE(i) + 0x0020)
    ...
    /*description: The raw interrupt status bit for tx_send_empty_int interrupt.when I2C sends more data than nonfifo_tx_thres*/
    ...
    /*description: The raw interrupt status bit for rx_rec_full_int interrupt. when I2C receives more data  than nonfifo_rx_thres*/
    ...
    /*description: The raw interrupt status bit for ack_err_int interrupt. when I2C receives a wrong ACK bit*/
    ...
    /*description: The raw interrupt status bit for trans_start_int interrupt. when I2C sends the START bit*/
    ...
    /*description: The raw interrupt status bit for time_out_int interrupt. when I2C takes a lot of time to receive a data*/
    ...
    /*description: The raw interrupt status bit for trans_complete_int interrupt. when I2C Master finished STOP command*/
    ...
    /*description: The raw interrupt status bit for master_tra_comp_int interrupt. when I2C Master sends or receives a byte*/
    ...
    /*description: The raw interrupt status bit for arbitration_lost_int interrupt.when I2C lost the usage right of I2C BUS*/
    ...
    /*description: The raw interrupt status bit for slave_tran_comp_int interrupt. when I2C Slave detectsthe STOP bit*/
    ...
    /*description: The raw interrupt status bit for end_detect_int interrupt. when I2C deals with  the END command*/
...
#define I2C_COMD0_REG(i)          (REG_I2C_BASE(i) + 0x0058)
    ...
    /*description: When command0 is done in I2C Master mode*/
    ...
    /*description: This is the content of command0. It consists of three part. op_code is the command*/
...
#define I2C_COMD1_REG(i)          (REG_I2C_BASE(i) + 0x005C)
    ...
    /*description: When command1 is done in I2C Master mode*/
    ...
    /*description: This is the content of command1. It consists of three part. op_code is the command*/
...
#define I2C_COMD2_REG(i)          (REG_I2C_BASE(i) + 0x0060)
    ...
    /*description: When command2 is done in I2C Master mode*/
    ...
    /*description: This is the content of command2. It consists of three part. op_code is the command*/
...
#define I2C_COMD3_REG(i)          (REG_I2C_BASE(i) + 0x0064)
    ...
    /*description: When command3 is done in I2C Master mode*/
    ...
    /*description: This is the content of command3. It consists of three part. op_code is the command*/
...
#define I2C_COMD4_REG(i)          (REG_I2C_BASE(i) + 0x0068)
    ...
    /*description: When command4 is done in I2C Master mode*/
    ...
    /*description: This is the content of command4. It consists of three part. op_code is the command*/
...
#define I2C_COMD5_REG(i)          (REG_I2C_BASE(i) + 0x006C)
    ...
    /*description: When command5 is done in I2C Master mode*/
    ...
    /*description: This is the content of command5. It consists of three part. op_code is the command*/
...
#define I2C_COMD6_REG(i)          (REG_I2C_BASE(i) + 0x0070)
    ...
    /*description: When command6 is done in I2C Master mode*/
    ...
    /*description: This is the content of command6. It consists of three part. op_code is the command*/
...
#define I2C_COMD7_REG(i)          (REG_I2C_BASE(i) + 0x0074)
    ...
    /*description: When command7 is done in I2C Master mode*/
    ...
    /*description: This is the content of command7. It consists of three part. op_code is the command*/
...
#define I2C_COMD8_REG(i)          (REG_I2C_BASE(i) + 0x0078)
    ...
    /*description: When command8 is done in I2C Master mode*/
    ...
    /*description: This is the content of command8. It consists of three part. op_code is the command*/
...
#define I2C_COMD9_REG(i)          (REG_I2C_BASE(i) + 0x007C)
    ...
    /*description: When command9 is done in I2C Master mode*/
    ...
    /*description: This is the content of command9. It consists of three part. op_code is the command*/
...
#define I2C_COMD10_REG(i)          (REG_I2C_BASE(i) + 0x0080)
    ...
    /*description: When command10 is done in I2C Master mode*/
    ...
    /*description: This is the content of command10. It consists of three part. op_code is the command*/
...
#define I2C_COMD11_REG(i)          (REG_I2C_BASE(i) + 0x0084)
    ...
    /*description: When command11 is done in I2C Master mode*/
    ...
    /*description: This is the content of command11. It consists of three part. op_code is the command*/
...
#define I2C_COMD12_REG(i)          (REG_I2C_BASE(i) + 0x0088)
    ...
    /*description: When command12 is done in I2C Master mode*/
    ...
    /*description: This is the content of command12. It consists of three part. op_code is the command*/
...
#define I2C_COMD13_REG(i)          (REG_I2C_BASE(i) + 0x008C)
    ...
    /*description: When command13 is done in I2C Master mode*/
    ...
    /*description: This is the content of command13. It consists of three part. op_code is the command*/
...
#define I2C_COMD14_REG(i)          (REG_I2C_BASE(i) + 0x0090)
    ...
    /*description: When command14 is done in I2C Master mode*/
    ...
    /*description: This is the content of command14. It consists of three part. op_code is the command*/
...
#define I2C_COMD15_REG(i)          (REG_I2C_BASE(i) + 0x0094)
    ...
    /*description: When command15 is done in I2C Master mode*/
    ...
    /*description: This is the content of command15. It consists of three part. op_code is the command*/
